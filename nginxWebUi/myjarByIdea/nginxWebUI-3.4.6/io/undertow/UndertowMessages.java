...
public interface UndertowMessages {
   UndertowMessages MESSAGES = (UndertowMessages)Messages.getBundle(UndertowMessages.class);
   ...
   @Message(
      id = 8,
      value = "Handler cannot be null"
   )
   IllegalArgumentException handlerCannotBeNull();

   @Message(
      id = 9,
      value = "Path must be specified"
   )
   IllegalArgumentException pathMustBeSpecified();

   @Message(
      id = 10,
      value = "Session is invalid %s"
   )
   IllegalStateException sessionIsInvalid(String var1);
   ...
   IllegalArgumentException argumentCannotBeNull(String var1);

   @Message(
      id = 17,
      value = "Form value is a file, use getFileItem() instead"
   )
   ...
   RequestTooBigException requestEntityWasTooLarge(long var1);
   ...
   IllegalArgumentException hashAlgorithmNotFound(String var1);

   @Message(
      id = 23,
      value = "An invalid Base64 token has been received."
   )
   IllegalArgumentException invalidBase64Token(@Cause IOException var1);
   ...
   IllegalArgumentException unexpectedTokenInHeader(String var1);

   @Message(
      id = 26,
      value = "Invalid header received."
   )
   ...
   String userAuthenticated(String var1);

   @Message(
      id = 31,
      value = "User %s has logged out."
   )
   String userLoggedOut(String var1);
   ...
   String authenticationFailed(String var1);

   @Message(
      id = 39,
      value = "Too many query parameters, cannot have more than %s query parameters"
   )
   BadRequestException tooManyQueryParameters(int var1);

   @Message(
      id = 40,
      value = "Too many headers, cannot have more than %s header"
   )
   String tooManyHeaders(int var1);
   ...
   @Message(
      id = 44,
      value = "More than one predicate with name %s. Builder class %s and %s"
   )
   IllegalStateException moreThanOnePredicateWithName(String var1, Class<? extends PredicateBuilder> var2, Class<? extends PredicateBuilder> var3);

   @Message(
      id = 45,
      value = "Error parsing predicated handler string %s:%n%s"
   )
   IllegalArgumentException errorParsingPredicateString(String var1, String var2);

   @Message(
      id = 46,
      value = "The number of cookies sent exceeded the maximum of %s"
   )
   IllegalStateException tooManyCookies(int var1);

   @Message(
      id = 47,
      value = "The number of parameters exceeded the maximum of %s"
   )
   ParameterLimitException tooManyParameters(int var1);
   ...
   @Message(
      id = 51,
      value = "Not a valid IP pattern %s"
   )
   IllegalArgumentException notAValidIpPattern(String var1);
   ...
   IllegalArgumentException listenerAlreadyRegistered(String var1);

   @Message(
      id = 54,
      value = "The maximum size %s for an individual file in a multipart request was exceeded"
   )
   MultiPartParserDefinition.FileTooLargeException maxFileSizeExceeded(long var1);

   @Message(
      id = 55,
      value = "Could not set attribute %s to %s as it is read only"
   )
   String couldNotSetAttribute(String var1, String var2);

   @Message(
      id = 56,
      value = "Could not parse URI template %s, exception at char %s"
   )
   RuntimeException couldNotParseUriTemplate(String var1, int var2);

   @Message(
      id = 57,
      value = "Mismatched braces in attribute string %s"
   )
   RuntimeException mismatchedBraces(String var1);

   @Message(
      id = 58,
      value = "More than one handler with name %s. Builder class %s and %s"
   )
   IllegalStateException moreThanOneHandlerWithName(String var1, Class<? extends HandlerBuilder> var2, Class<? extends HandlerBuilder> var3);
   ...
   IOException wrongMagicNumber(int var1);

   @Message(
      id = 67,
      value = "No client cert was provided"
   )
   ...
   IllegalArgumentException couldNotParseCookie(String var1);
   ...
   IllegalStateException matcherAlreadyContainsTemplate(String var1, String var2);

   @Message(
      id = 72,
      value = "Failed to decode url %s to charset %s"
   )
   UrlDecodeException failedToDecodeURL(String var1, String var2, @Cause Exception var3);
   ...
   IllegalArgumentException notAValidRegularExpressionPattern(String var1);
   ...
   RuntimeException hostAlreadyRegistered(Object var1);

   @Message(
      id = 83,
      value = "Host %s has not been registered"
   )
   RuntimeException hostHasNotBeenRegistered(Object var1);
   ...
   String streamIdMustBeZeroForFrameType(int var1);

   @Message(
      id = 101,
      value = "stream id must not be zero for frame type %s"
   )
   String streamIdMustNotBeZeroForFrameType(int var1);
   ...
   HpackException integerEncodedOverTooManyOctets(int var1);
   ...
   IllegalArgumentException invalidAclRule(String var1);
   ...
   IllegalStateException tooManySessions(int var1);

   @Message(
      id = 122,
      value = "CONNECT attempt failed as target proxy returned %s"
   )
   IOException proxyConnectionFailed(int var1);

   @Message(
      id = 123,
      value = "MCMP message %s rejected due to suspicious characters"
   )
   RuntimeException mcmpMessageRejectedDueToSuspiciousCharacters(String var1);
   ...
   IllegalStateException reasonPhraseToLargeForBuffer(String var1);

   @Message(
      id = 131,
      value = "Buffer pool is closed"
   )
   ...
   IllegalStateException authenticationPropertyNotSet(String var1, String var2);
   ...
   IllegalArgumentException userAgentCharsetMustHaveEvenNumberOfItems(String var1);

   @Message(
      id = 137,
      value = "Could not find the datasource called %s"
   )
   IllegalArgumentException datasourceNotFound(String var1);
   ...
   IOException tooManyRedirects(@Cause IOException var1);
   ...
   @Message(
      id = 148,
      value = "Invalid HPack encoding. First byte: %s"
   )
   HpackException invalidHpackEncoding(byte var1);

   @Message(
      id = 149,
      value = "HttpString is not allowed to contain newlines. value: %s"
   )
   IllegalArgumentException newlineNotSupportedInHttpString(String var1);

   @Message(
      id = 150,
      value = "Pseudo header %s received after receiving normal headers. Pseudo headers must be the first headers in a HTTP/2 header block."
   )
   String pseudoHeaderInWrongOrder(HttpString var1);

   @Message(
      id = 151,
      value = "Expected to receive a continuation frame"
   )
   String expectedContinuationFrame();

   @Message(
      id = 152,
      value = "Incorrect frame size"
   )
   String incorrectFrameSize();

   @Message(
      id = 153,
      value = "Stream id not registered"
   )
   IllegalStateException streamNotRegistered();

   @Message(
      id = 154,
      value = "Mechanism %s returned a null result from sendChallenge()"
   )
   NullPointerException sendChallengeReturnedNull(AuthenticationMechanism var1);

   @Message(
      id = 155,
      value = "Framed channel body was set when it was not ready for flush"
   )
   ...
   @Message(
      id = 157,
      value = "Invalid GZIP footer"
   )
   IOException invalidGZIPFooter();

   @Message(
      id = 158,
      value = "Response of length %s is too large to buffer"
   )
   IllegalStateException responseTooLargeToBuffer(Long var1);

   @Message(
      id = 161,
      value = "HTTP/2 header block is too large"
   )
   String headerBlockTooLarge();

   @Message(
      id = 162,
      value = "An invalid SameSite attribute [%s] is specified. It must be one of %s"
   )
   IllegalArgumentException invalidSameSiteMode(String var1, String var2);

   @Message(
      id = 163,
      value = "Invalid token %s"
   )
   IllegalArgumentException invalidToken(byte var1);

   @Message(
      id = 164,
      value = "Request contained invalid headers"
   )
   IllegalArgumentException invalidHeaders();

   @Message(
      id = 165,
      value = "Invalid character %s in request-target"
   )
   String invalidCharacterInRequestTarget(char var1);

   @Message(
      id = 166,
      value = "Pooled object is closed"
   )
   IllegalStateException objectIsClosed();

   @Message(
      id = 167,
      value = "More than one host header in request"
   )
   IOException moreThanOneHostHeader();

   @Message(
      id = 168,
      value = "An invalid character [ASCII code: %s] was present in the cookie value"
   )
   IllegalArgumentException invalidCookieValue(String var1);

   @Message(
      id = 169,
      value = "An invalid domain [%s] was specified for this cookie"
   )
   IllegalArgumentException invalidCookieDomain(String var1);

   @Message(
      id = 170,
      value = "An invalid path [%s] was specified for this cookie"
   )
   IllegalArgumentException invalidCookiePath(String var1);

   @Message(
      id = 173,
      value = "An invalid control character [%s] was present in the cookie value or attribute"
   )
   IllegalArgumentException invalidControlCharacter(String var1);

   @Message(
      id = 174,
      value = "An invalid escape character in cookie value"
   )
   IllegalArgumentException invalidEscapeCharacter();

   @Message(
      id = 175,
      value = "Invalid Hpack index %s"
   )
   HpackException invalidHpackIndex(int var1);

   @Message(
      id = 178,
      value = "Buffer pool is too small, min size is %s"
   )
   IllegalArgumentException bufferPoolTooSmall(int var1);

   @Message(
      id = 179,
      value = "Invalid PROXY protocol header"
   )
   IOException invalidProxyHeader();

   @Message(
      id = 180,
      value = "PROXY protocol header exceeded max size of 107 bytes"
   )
   IOException headerSizeToLarge();

   @Message(
      id = 181,
      value = "HTTP/2 trailers too large for single buffer"
   )
   RuntimeException http2TrailerToLargeForSingleBuffer();

   @Message(
      id = 182,
      value = "Ping not supported"
   )
   IOException pingNotSupported();

   @Message(
      id = 183,
      value = "Ping timed out"
   )
   IOException pingTimeout();

   @Message(
      id = 184,
      value = "Stream limit exceeded"
   )
   IOException streamLimitExceeded();

   @Message(
      id = 185,
      value = "Invalid IP address %s"
   )
   IOException invalidIpAddress(String var1);

   @Message(
      id = 186,
      value = "Invalid TLS extension"
   )
   ...
   @Message(
      id = 188,
      value = "Empty host name in SNI extension"
   )
   SSLException emptyHostNameSni();

   @Message(
      id = 189,
      value = "Duplicated host name of type %s"
   )
   SSLException duplicatedSniServerName(int var1);

   @Message(
      id = 190,
      value = "No context for SSL connection"
   )
   SSLException noContextForSslConnection();

   @Message(
      id = 191,
      value = "Default context cannot be null"
   )
   IllegalStateException defaultContextCannotBeNull();

   @Message(
      id = 192,
      value = "Form value is a in-memory file, use getFileItem() instead"
   )
   IllegalStateException formValueIsInMemoryFile();

   @Message(
      id = 193,
      value = "Character decoding failed. Parameter [%s] with value [%s] has been ignored. Note: further occurrences of Parameter errors will be logged at DEBUG level."
   )
   String failedToDecodeParameterValue(String var1, String var2, @Cause Exception var3);

   @Message(
      id = 194,
      value = "Character decoding failed. Parameter with name [%s] has been ignored. Note: further occurrences of Parameter errors will be logged at DEBUG level."
   )
   String failedToDecodeParameterName(String var1, @Cause Exception var2);
   ...
   @Message(
      id = 196,
      value = "Session with id %s already exists"
   )
   IllegalStateException sessionWithIdAlreadyExists(String var1);

   @Message(
      id = 197,
      value = "Blocking read timed out after %s nanoseconds."
   )
   ReadTimeoutException blockingReadTimedOut(long var1);

   @Message(
      id = 198,
      value = "Blocking write timed out after %s nanoseconds."
   )
   WriteTimeoutException blockingWriteTimedOut(long var1);

   @Message(
      id = 199,
      value = "Read timed out after %s milliseconds."
   )
   ReadTimeoutException readTimedOut(long var1);

   @Message(
      id = 200,
      value = "Failed to replace hash output stream "
   )
   SSLException failedToReplaceHashOutputStream(@Cause Exception var1);

   @Message(
      id = 201,
      value = "Failed to replace hash output stream "
   )
   RuntimeException failedToReplaceHashOutputStreamOnWrite(@Cause Exception var1);

   @Message(
      id = 202,
      value = "Failed to initialize path manager for '%s' path."
   )
   RuntimeException failedToInitializePathManager(String var1, @Cause IOException var2);

   @Message(
      id = 203,
      value = "Invalid ACL entry"
   )
   IllegalArgumentException invalidACLAddress(@Cause Exception var1);

   @Message(
      id = 204,
      value = "Out of flow control window: no WINDOW_UPDATE received from peer within %s miliseconds"
   )
   IOException noWindowUpdate(long var1);

   @Message(
      id = 205,
      value = "Path is not a directory '%s'"
   )
   IOException pathNotADirectory(Path var1);

   @Message(
      id = 206,
      value = "Path '%s' is not a directory"
   )
   IOException pathElementIsRegularFile(Path var1);
}
