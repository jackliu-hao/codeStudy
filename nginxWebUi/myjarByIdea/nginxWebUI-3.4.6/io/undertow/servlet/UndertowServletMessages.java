...
public interface UndertowServletMessages {
   UndertowServletMessages MESSAGES = (UndertowServletMessages)Messages.getBundle(UndertowServletMessages.class);

   @Message(
      id = 10000,
      value = "%s cannot be null"
   )
   IllegalArgumentException paramCannotBeNull(String var1);

   @Message(
      id = 10001,
      value = "%s cannot be null for %s named %s"
   )
   IllegalArgumentException paramCannotBeNull(String var1, String var2, String var3);

   @Message(
      id = 10002,
      value = "Deployments can only be removed when in undeployed state, but state was %s"
   )
   IllegalStateException canOnlyRemoveDeploymentsWhenUndeployed(DeploymentManager.State var1);
   ...
   IllegalArgumentException twoServletsWithSameMapping(String var1);

   @Message(
      id = 10008,
      value = "Header %s cannot be converted to a date"
   )
   IllegalArgumentException headerCannotBeConvertedToDate(String var1);

   @Message(
      id = 10009,
      value = "Servlet %s of type %s does not implement javax.servlet.Servlet"
   )
   IllegalArgumentException servletMustImplementServlet(String var1, Class<? extends Servlet> var2);

   @Message(
      id = 10010,
      value = "%s of type %s must have a default constructor"
   )
   IllegalArgumentException componentMustHaveDefaultConstructor(String var1, Class<?> var2);

   @Message(
      id = 10011,
      value = "Filter %s of type %s does not implement javax.servlet.Filter"
   )
   IllegalArgumentException filterMustImplementFilter(String var1, Class<? extends Filter> var2);

   @Message(
      id = 10012,
      value = "Listener class %s must implement at least one listener interface"
   )
   IllegalArgumentException listenerMustImplementListenerClass(Class<?> var1);

   @Message(
      id = 10013,
      value = "Could not instantiate %s"
   )
   ServletException couldNotInstantiateComponent(String var1, @Cause Exception var2);

   @Message(
      id = 10014,
      value = "Could not load class %s"
   )
   RuntimeException cannotLoadClass(String var1, @Cause Exception var2);

   @Message(
      id = 10015,
      value = "Could not delete file %s"
   )
   IOException deleteFailed(Path var1);
   ...
   MalformedURLException pathMustStartWithSlash(String var1);
   ...
   IllegalArgumentException requestWasNotOriginalOrWrapper(ServletRequest var1);

   @Message(
      id = 10024,
      value = "Response %s was not original or a wrapper"
   )
   IllegalArgumentException responseWasNotOriginalOrWrapper(ServletResponse var1);
   ...
   RuntimeException unknownAuthenticationMechanism(String var1);

   @Message(
      id = 10040,
      value = "More than one default error page %s and %s"
   )
   IllegalStateException moreThanOneDefaultErrorPage(String var1, String var2);
   ...
   IllegalArgumentException couldNotFindContextToDispatchTo(String var1);
   ...
   IllegalArgumentException invalidRequestResponseType(ServletRequest var1, ServletResponse var2);
   ...
   IllegalStateException filterNotFound(String var1, String var2);

   @Message(
      id = 10051,
      value = "Deployment %s has stopped"
   )
   ServletException deploymentStopped(String var1);
   ...
   RuntimeException couldNotCreateFactory(String var1, @Cause Exception var2);
   ...
   NullPointerException paramCannotBeNullNPE(String var1);

   @Message(
      id = 10060,
      value = "Trailers not supported for this request due to %s"
   )
   IllegalStateException trailersNotSupported(String var1);

   @Message(
      id = 10061,
      value = "Invalid method for push request %s"
   )
   IllegalArgumentException invalidMethodForPushRequest(String var1);
   ...
   IllegalArgumentException pathMustStartWithSlashForRequestDispatcher(String var1);

   @Message(
      id = 10064,
      value = "Servlet context for context path '%s' in deployment '%s' has already been initialized, can not declare roles."
   )
   IllegalStateException servletAlreadyInitialize(String var1, String var2);

   @Message(
      id = 10065,
      value = "Can not set empty/null role in servlet context for context path '%s' in deployment '%s' "
   )
   IllegalArgumentException roleMustNotBeEmpty(String var1, String var2);

   @Message(
      id = 10066,
      value = "Can not set invoke 'declareRoles' from dynamic listener in servlet context for context path '%s' in deployment '%s' "
   )
   UnsupportedOperationException cantCallFromDynamicListener(String var1, String var2);
}
