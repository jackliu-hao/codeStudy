...
public final class RmiDebuggedEnvironmentImpl_Stub extends RemoteStub implements DebuggedEnvironment, DebugModel, Remote {
   ...
   static {
      try {
         ...
         $method_getId_10 = (class$freemarker$debug$DebuggedEnvironment != null ? class$freemarker$debug$DebuggedEnvironment : (class$freemarker$debug$DebuggedEnvironment = class$("freemarker.debug.DebuggedEnvironment"))).getMethod("getId");
         $method_getModelTypes_11 = (class$freemarker$debug$DebugModel != null ? class$freemarker$debug$DebugModel : (class$freemarker$debug$DebugModel = class$("freemarker.debug.DebugModel"))).getMethod("getModelTypes");
         $method_keys_12 = (class$freemarker$debug$DebugModel != null ? class$freemarker$debug$DebugModel : (class$freemarker$debug$DebugModel = class$("freemarker.debug.DebugModel"))).getMethod("keys");
         $method_resume_13 = (class$freemarker$debug$DebuggedEnvironment != null ? class$freemarker$debug$DebuggedEnvironment : (class$freemarker$debug$DebuggedEnvironment = class$("freemarker.debug.DebuggedEnvironment"))).getMethod("resume");
         $method_size_14 = (class$freemarker$debug$DebugModel != null ? class$freemarker$debug$DebugModel : (class$freemarker$debug$DebugModel = class$("freemarker.debug.DebugModel"))).getMethod("size");
         $method_stop_15 = (class$freemarker$debug$DebuggedEnvironment != null ? class$freemarker$debug$DebuggedEnvironment : (class$freemarker$debug$DebuggedEnvironment = class$("freemarker.debug.DebuggedEnvironment"))).getMethod("stop");
      } catch (NoSuchMethodException var0) {
         throw new NoSuchMethodError("stub class initialization failed");
      }
   }

   public RmiDebuggedEnvironmentImpl_Stub(RemoteRef var1) {
      super(var1);
   }
   ...
   public long getId() throws RemoteException {
      try {
         Object var1 = super.ref.invoke(this, $method_getId_10, (Object[])null, -6040770469254561000L);
         return (Long)var1;
      } catch (RuntimeException var2) {
         throw var2;
      } catch (RemoteException var3) {
   ...
   public int getModelTypes() throws RemoteException {
      try {
         Object var1 = super.ref.invoke(this, $method_getModelTypes_11, (Object[])null, -3673171458095957561L);
         return (Integer)var1;
      } catch (RuntimeException var2) {
         throw var2;
      } catch (RemoteException var3) {
   ...
   public String[] keys() throws TemplateModelException, RemoteException {
      try {
         Object var1 = super.ref.invoke(this, $method_keys_12, (Object[])null, 563174456558742983L);
         return (String[])var1;
      } catch (RuntimeException var2) {
         throw var2;
      } catch (RemoteException var3) {
   ...
   public void resume() throws RemoteException {
      try {
         super.ref.invoke(this, $method_resume_13, (Object[])null, 4126995468303716546L);
      } catch (RuntimeException var2) {
         throw var2;
      } catch (RemoteException var3) {
         throw var3;
   ...
   public int size() throws TemplateModelException, RemoteException {
      try {
         Object var1 = super.ref.invoke(this, $method_size_14, (Object[])null, 4495240443643581991L);
         return (Integer)var1;
      } catch (RuntimeException var2) {
         throw var2;
      } catch (RemoteException var3) {
   ...
   public void stop() throws RemoteException {
      try {
         super.ref.invoke(this, $method_stop_15, (Object[])null, -2856118408655404442L);
      } catch (RuntimeException var2) {
         throw var2;
      } catch (RemoteException var3) {
         throw var3;
