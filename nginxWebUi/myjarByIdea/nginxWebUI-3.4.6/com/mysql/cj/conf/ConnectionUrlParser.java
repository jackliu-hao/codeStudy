...
public class ConnectionUrlParser implements DatabaseUrlContainer {
   ...
   private ConnectionUrlParser(String connString) {
      if (connString == null) {
         ...
         throw (UnsupportedConnectionStringException)ExceptionFactory.createException(UnsupportedConnectionStringException.class, Messages.getString("ConnectionString.17", new String[]{connString}));
      } else {
   ...
   private HostInfo buildHostInfoForEmptyHost(String user, String password, String hostInfo) {
      return StringUtils.isNullOrEmpty(hostInfo) ? new HostInfo(this, (String)null, -1, user, password) : null;
   }
