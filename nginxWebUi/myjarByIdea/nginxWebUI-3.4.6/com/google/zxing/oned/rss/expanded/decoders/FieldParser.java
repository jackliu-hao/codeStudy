...
final class FieldParser {
   ...
   static String parseFieldsInGeneralPurpose(String rawInformation) throws NotFoundException {
      if (rawInformation.isEmpty()) {
         ...
         Object[][] var2;
         int var3 = (var2 = TWO_DIGIT_DATA_LENGTH).length;

         int var4;
         for(var4 = 0; var4 < var3; ++var4) {
            Object[] dataLength;
            if ((dataLength = var2[var4])[0].equals(firstTwoDigits)) {
         ...
         if (rawInformation.length() < 3) {
            ...
            Object[][] var9;
            var4 = (var9 = THREE_DIGIT_DATA_LENGTH).length;

            Object[] dataLength;
            int var11;
            for(var11 = 0; var11 < var4; ++var11) {
               if ((dataLength = var9[var11])[0].equals(firstThreeDigits)) {
                  if (dataLength[1] == VARIABLE_LENGTH) {
            ...
            var4 = (var9 = THREE_DIGIT_PLUS_DIGIT_DATA_LENGTH).length;
            ...
            if (rawInformation.length() < 4) {
               ...
               Object[][] var12;
               var11 = (var12 = FOUR_DIGIT_DATA_LENGTH).length;

               for(int var13 = 0; var13 < var11; ++var13) {
                  Object[] dataLength;
                  if ((dataLength = var12[var13])[0].equals(firstFourDigits)) {
                     if (dataLength[1] == VARIABLE_LENGTH) {
                        return processVariableAI(4, (Integer)dataLength[2], rawInformation);
                     }
   ...
   private static String processFixedAI(int aiSize, int fieldSize, String rawInformation) throws NotFoundException {
      if (rawInformation.length() < aiSize) {
         ...
         if (rawInformation.length() < aiSize + fieldSize) {
            ...
            String parsedAI;
            return (parsedAI = parseFieldsInGeneralPurpose(remaining)) == null ? result : result + parsedAI;
         }
      }
   }
