...
public final class Version {
   ...
   private Version(int versionNumber, int symbolSizeRows, int symbolSizeColumns, int dataRegionSizeRows, int dataRegionSizeColumns, ECBlocks ecBlocks) {
      ...
      ECB[] var9;
      int var10 = (var9 = ecBlocks.getECBlocks()).length;

      for(int var11 = 0; var11 < var10; ++var11) {
         ECB ecBlock = var9[var11];
   ...
   public static Version getVersionForDimensions(int numRows, int numColumns) throws FormatException {
      if ((numRows & 1) == 0 && (numColumns & 1) == 0) {
         Version[] var2;
         int var3 = (var2 = VERSIONS).length;

         for(int var4 = 0; var4 < var3; ++var4) {
            Version version;
            if ((version = var2[var4]).symbolSizeRows == numRows && version.symbolSizeColumns == numColumns) {
               return version;
            }
         }
   ...
   static final class ECBlocks {
      ...
      // $FF: synthetic method
      ECBlocks(int x0, ECB x1, Object x2) {
         this(x0, x1);
      }

      // $FF: synthetic method
      ECBlocks(int x0, ECB x1, ECB x2, Object x3) {
         this(x0, x1, x2);
      }
   }
}
