...
public final class Version {
   ...
   private Version(int versionNumber, int[] alignmentPatternCenters, ECBlocks... ecBlocks) {
      ...
      ECB[] var6;
      int var7 = (var6 = ecBlocks[0].getECBlocks()).length;

      for(int var8 = 0; var8 < var7; ++var8) {
         ECB ecBlock = var6[var8];
   ...
   static Version decodeVersionInformation(int versionBits) {
      ...
      for(int i = 0; i < VERSION_DECODE_INFO.length; ++i) {
         int targetVersion;
         if ((targetVersion = VERSION_DECODE_INFO[i]) == versionBits) {
            return getVersionForNumber(i + 7);
         }

         int bitsDifference;
         if ((bitsDifference = FormatInformation.numBitsDiffering(versionBits, targetVersion)) < bestDifference) {
            bestVersion = i + 7;
   ...
   BitMatrix buildFunctionPattern() {
      ...
      BitMatrix bitMatrix;
      (bitMatrix = new BitMatrix(dimension)).setRegion(0, 0, 9, 9);
   ...
   public static final class ECBlocks {
      ...
      public int getNumBlocks() {
         int total = 0;
         ECB[] var2;
         int var3 = (var2 = this.ecBlocks).length;

         for(int var4 = 0; var4 < var3; ++var4) {
            ECB ecBlock = var2[var4];
