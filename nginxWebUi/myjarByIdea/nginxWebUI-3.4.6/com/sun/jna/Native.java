...
public final class Native implements Version {
   ...
   private static Charset getCharset(String encoding) {
      ...
      if (encoding != null) {
         try {
            ...
            LOG.log(Level.WARNING, "JNA Warning: Encoding ''{0}'' is unsupported ({1})", new Object[]{encoding, var3.getMessage()});
         } catch (UnsupportedCharsetException var4) {
            LOG.log(Level.WARNING, "JNA Warning: Encoding ''{0}'' is unsupported ({1})", new Object[]{encoding, var4.getMessage()});
         }
      }
   ...
   public static String toString(byte[] buf, Charset charset) {
      ...
      return len == 0 ? "" : new String(buf, 0, len, charset);
   }
   ...
   public static <T extends Library> T load(Class<T> interfaceClass) {
      return load((String)null, (Class)interfaceClass);
   }

   public static <T extends Library> T load(Class<T> interfaceClass, Map<String, ?> options) {
      return load((String)null, interfaceClass, options);
   }
   ...
   public static <T extends Library> T load(String name, Class<T> interfaceClass, Map<String, ?> options) {
      if (!Library.class.isAssignableFrom(interfaceClass)) {
         ...
         return (Library)interfaceClass.cast(proxy);
      }
   }
   ...
   static Class<?> findEnclosingLibraryClass(Class<?> cls) {
      if (cls == null) {
         ...
         Map<String, ?> libOptions = (Map)typeOptions.get(cls);
         Class declaring;
         if (libOptions != null) {
            declaring = (Class)libOptions.get("enclosing-library");
            return declaring != null ? declaring : cls;
            ...
            declaring = cls.getDeclaringClass();
   ...
   public static Map<String, Object> getLibraryOptions(Class<?> type) {
      Map<String, Object> libraryOptions = (Map)typeOptions.get(type);
      if (libraryOptions != null) {
         ...
         if (libraryOptions != null) {
            ...
            try {
               ...
               throw new IllegalArgumentException("OPTIONS must be a public field of type java.util.Map (" + var5 + "): " + mappingClass);
            }

            Map<String, Object> libraryOptions = new HashMap(libraryOptions);
   ...
   private static void loadNativeDispatchLibrary() {
      if (!Boolean.getBoolean("jna.nounpack")) {
         try {
            ...
            LOG.log(Level.WARNING, "JNA Warning: IOException removing temporary files", var9);
         }
      }
            ...
            if (Platform.isMac()) {
               ...
               if ((new File(path)).exists()) {
                  try {
                     ...
                     LOG.log(Level.WARNING, "File found at " + path + " but not loadable: " + var11.getMessage(), var11);
                  }
               }
            }
         }
   ...
   private static void loadNativeDispatchLibraryFromClasspath() {
      try {
         ...
         throw new UnsatisfiedLinkError(var3.getMessage());
      }
   }
   ...
   public static File extractFromResourcePath(String name, ClassLoader loader) throws IOException {
      Level DEBUG = !DEBUG_LOAD && (!DEBUG_JNA_LOAD || !name.contains("jnidispatch")) ? Level.FINE : Level.INFO;
      if (loader == null) {
   ...
   public static String getWebStartLibraryPath(String libName) {
      if (System.getProperty("javawebstart.version") == null) {
         ...
         try {
            ...
            Method m = (Method)AccessController.doPrivileged(new PrivilegedAction<Method>() {
               public Method run() {
                  try {
   ...
   private static void unregisterAll() {
      synchronized(registeredClasses) {
         ...
         while(var1.hasNext()) {
            Map.Entry<Class<?>, long[]> e = (Map.Entry)var1.next();
   ...
   public static void main(String[] args) {
      ...
      String DEFAULT_VERSION = "5.6.0";
      String DEFAULT_BUILD = "5.6.0 (package information missing)";
      ...
      String version = pkg != null ? pkg.getSpecificationVersion() : "5.6.0";
      if (version == null) {
         version = "5.6.0";
      }
      ...
      version = pkg != null ? pkg.getImplementationVersion() : "5.6.0 (package information missing)";
      if (version == null) {
         version = "5.6.0 (package information missing)";
      }
   ...
   static {
      ...
      if (!isCompatibleVersion("6.1.0", getNativeVersion())) {
         ...
         MAX_ALIGNMENT = !Platform.isSPARC() && !Platform.isWindows() && (!Platform.isLinux() || !Platform.isARM() && !Platform.isPPC() && !Platform.isMIPS()) && !Platform.isAIX() && (!Platform.isAndroid() || Platform.isIntel()) ? LONG_SIZE : 8;
