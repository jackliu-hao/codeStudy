...
public class StringArray extends Memory implements Function.PostCallRead {
   ...
   private StringArray(Object[] strings, String encoding) {
      ...
      for(int i = 0; i < strings.length; ++i) {
         ...
         this.setPointer((long)(Native.POINTER_SIZE * i), p);
      }

      this.setPointer((long)(Native.POINTER_SIZE * strings.length), (Pointer)null);
   }
   ...
   public void read() {
      ...
      for(int si = 0; si < this.original.length; ++si) {
         Pointer p = this.getPointer((long)(si * Native.POINTER_SIZE));
         Object s = null;
         if (p != null) {
