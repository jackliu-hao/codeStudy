...
public interface SystemB extends LibCAPI, Library {
   ...
   int HOST_LOAD_INFO = 1;
   int HOST_VM_INFO = 2;
   int HOST_CPU_LOAD_INFO = 3;
   ...
   int MAXCOMLEN = 16;
   int MAXPATHLEN = 1024;
   int PROC_PIDPATHINFO_MAXSIZE = 4096;
   int PROC_ALL_PIDS = 1;
   ...
   int gettimeofday(Timeval var1, Timezone var2);

   int mach_host_self();

   int mach_task_self();

   int mach_port_deallocate(int var1, int var2);

   int host_page_size(int var1, LongByReference var2);

   int host_statistics(int var1, int var2, Structure var3, IntByReference var4);

   int host_statistics64(int var1, int var2, Structure var3, IntByReference var4);
   ...
   int host_processor_info(int var1, int var2, IntByReference var3, PointerByReference var4, IntByReference var5);

   Passwd getpwuid(int var1);

   Group getgrgid(int var1);

   int proc_listpids(int var1, int var2, int[] var3, int var4);

   int proc_pidinfo(int var1, int var2, long var3, Structure var5, int var6);

   int proc_pidpath(int var1, Pointer var2, int var3);

   int proc_pid_rusage(int var1, int var2, RUsageInfoV2 var3);

   int getfsstat64(Statfs[] var1, int var2, int var3);
