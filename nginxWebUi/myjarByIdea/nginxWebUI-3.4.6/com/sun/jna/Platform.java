...
public final class Platform {
   ...
   public static final boolean is64Bit() {
      ...
      } else if (!"x86-64".equals(ARCH) && !"ia64".equals(ARCH) && !"ppc64".equals(ARCH) && !"ppc64le".equals(ARCH) && !"sparcv9".equals(ARCH) && !"mips64".equals(ARCH) && !"mips64el".equals(ARCH) && !"amd64".equals(ARCH) && !"aarch64".equals(ARCH)) {
