...
public final class BsdSysctlUtil {
   ...
   public static int sysctl(String name, int def) {
      ...
      if (0 != FreeBsdLibc.INSTANCE.sysctlbyname(name, p, size, (Pointer)null, 0)) {
   ...
   public static long sysctl(String name, long def) {
      ...
      Pointer p = new Memory((long)size.getValue());
      if (0 != FreeBsdLibc.INSTANCE.sysctlbyname(name, p, size, (Pointer)null, 0)) {
         LOG.warn((String)"Failed syctl call: {}, Error code: {}", (Object)name, (Object)Native.getLastError());
         return def;
      } else {
         return p.getLong(0L);
      }
   ...
   public static String sysctl(String name, String def) {
      ...
      if (0 != FreeBsdLibc.INSTANCE.sysctlbyname(name, (Pointer)null, size, (Pointer)null, 0)) {
         LOG.warn((String)"Failed syctl call: {}, Error code: {}", (Object)name, (Object)Native.getLastError());
         return def;
      } else {
   ...
   public static boolean sysctl(String name, Structure struct) {
      if (0 != FreeBsdLibc.INSTANCE.sysctlbyname(name, struct.getPointer(), new IntByReference(struct.size()), (Pointer)null, 0)) {
