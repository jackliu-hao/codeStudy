...
public class FreeBsdOSFileStore extends AbstractOSFileStore {
   ...
   public boolean updateAttributes() {
      Iterator var1 = (new FreeBsdFileSystem()).getFileStores().iterator();
      ...
      } while(!this.getName().equals(fileStore.getName()) || !this.getVolume().equals(fileStore.getVolume()) || !this.getMount().equals(fileStore.getMount()));
