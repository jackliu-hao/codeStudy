...
class FileNioMem extends FileBaseDefault {
   ...
   FileNioMem(FileNioMemData var1, boolean var2) {
      this.data = var1;
      this.readOnly = var2;
   }
   ...
   public int write(ByteBuffer var1, long var2) throws IOException {
      if (this.closed) {
         ...
         this.data.touch(this.readOnly);
         long var4 = this.data.readWrite(var2, var1, 0, var1.remaining(), true);
         int var6 = (int)(var4 - var2);
         var1.position(var1.position() + var6);
         return var6;
      }
   }
   ...
   public int read(ByteBuffer var1, long var2) throws IOException {
      if (this.closed) {
         ...
         if (var4 == 0) {
            ...
            long var5 = this.data.readWrite(var2, var1, var1.position(), var4, false);
            var4 = (int)(var5 - var2);
            if (var4 <= 0) {
               return -1;
            } else {
