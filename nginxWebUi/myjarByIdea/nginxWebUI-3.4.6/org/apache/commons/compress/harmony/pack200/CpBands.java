...
public class CpBands extends BandSet {
   ...
   private void writeCpUtf8(OutputStream out) throws IOException, Pack200Exception {
      ...
      for(int i = 2; i < cpUtf8Array.length; ++i) {
         ...
         for(j = 0; j < previous.length && previous[j] == current[j]; ++j) {
            ++i;
         }
      ...
      for(i = 0; i < cpUtf8Chars.length; ++i) {
         cpUtf8Chars[i] = (Character)chars.get(i);
      }

      for(i = 0; i < cpUtf8BigSuffix.length; ++i) {
         i = (Integer)bigSuffix.get(i);
         cpUtf8BigSuffix[i] = i;
         cpUtf8BigChars[i] = new int[i];

         for(j = 0; j < i; ++j) {
            cpUtf8BigChars[i][j] = (Character)bigChars.remove(0);
         }
      }
      ...
      for(i = 0; i < cpUtf8BigChars.length; ++i) {
   ...
   private void writeCpInt(OutputStream out) throws IOException, Pack200Exception {
      ...
      for(Iterator iterator = this.cp_Int.iterator(); iterator.hasNext(); ++i) {
   ...
   private void writeCpFloat(OutputStream out) throws IOException, Pack200Exception {
      ...
      for(Iterator iterator = this.cp_Float.iterator(); iterator.hasNext(); ++i) {
   ...
   private void writeCpLong(OutputStream out) throws IOException, Pack200Exception {
      ...
      for(Iterator iterator = this.cp_Long.iterator(); iterator.hasNext(); ++i) {
   ...
   private void writeCpDouble(OutputStream out) throws IOException, Pack200Exception {
      ...
      for(Iterator iterator = this.cp_Double.iterator(); iterator.hasNext(); ++i) {
   ...
   private void writeCpString(OutputStream out) throws IOException, Pack200Exception {
      ...
      for(Iterator iterator = this.cp_String.iterator(); iterator.hasNext(); ++i) {
   ...
   private void writeCpClass(OutputStream out) throws IOException, Pack200Exception {
      ...
      for(Iterator iterator = this.cp_Class.iterator(); iterator.hasNext(); ++i) {
   ...
   private void writeCpSignature(OutputStream out) throws IOException, Pack200Exception {
      ...
      for(Iterator iterator = this.cp_Signature.iterator(); iterator.hasNext(); ++i) {
   ...
   private void writeCpDescr(OutputStream out) throws IOException, Pack200Exception {
      ...
      for(Iterator iterator = this.cp_Descr.iterator(); iterator.hasNext(); ++i) {
   ...
   private void writeCpMethodOrField(Set cp, OutputStream out, String name) throws IOException, Pack200Exception {
      ...
      for(Iterator iterator = cp.iterator(); iterator.hasNext(); ++i) {
   ...
   private void removeSignaturesFromCpUTF8() {
      Iterator iterator = this.cp_Signature.iterator();
   ...
   private void addIndices() {
      ...
      for(int i = 0; i < sets.length; ++i) {
         ...
         for(iterator = sets[i].iterator(); iterator.hasNext(); ++j) {
      ...
      Iterator iterator = this.cp_Field.iterator();
      ...
      iterator = this.cp_Method.iterator();
            ...
            if (signature.length() > 1 && signature.indexOf(76) != -1) {
               ...
               while(true) {
                  if (i >= chars.length) {
                     ...
                     CPClass cpClass;
                     for(Iterator iterator2 = classes.iterator(); iterator2.hasNext(); cpClasses.add(cpClass)) {
