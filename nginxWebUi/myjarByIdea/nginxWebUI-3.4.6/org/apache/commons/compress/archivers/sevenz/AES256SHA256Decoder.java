   ...
   InputStream decode(final String archiveName, final InputStream in, long uncompressedLength, final Coder coder, final byte[] passwordBytes, int maxMemoryLimitInKb) throws IOException {
      return new InputStream() {
         ...
         private CipherInputStream init() throws IOException {
            ...
            } else if (coder.properties == null) {
               throw new IOException("Missing AES256 properties in " + archiveName);
            } else if (coder.properties.length < 2) {
                  ...
                  if (passwordBytes == null) {
                     ...
                     if (numCyclesPower == 63) {
                        ...
                        try {
                           ...
                           throw new IOException("SHA-256 is unsupported by your Java implementation", var15);
                        }
                     ...
                     try {
                        ...
                        throw new IOException("Decryption error (do you have the JCE Unlimited Strength Jurisdiction Policy Files installed?)", var14);
                     }
                  }
               }
            }
