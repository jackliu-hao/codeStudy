...
public class EntityBuilder {
   ...
   public HttpEntity build() {
      ...
      if (this.text != null) {
         ...
         ((AbstractHttpEntity)e).setContentType(ContentType.DEFAULT_BINARY.toString());
      ...
      if (((AbstractHttpEntity)e).getContentType() != null && this.contentType != null) {
         ((AbstractHttpEntity)e).setContentType(this.contentType.toString());
      }

      ((AbstractHttpEntity)e).setContentEncoding(this.contentEncoding);
      ((AbstractHttpEntity)e).setChunked(this.chunked);
      return (HttpEntity)(this.gzipCompress ? new GzipCompressingEntity((HttpEntity)e) : e);
   }
}
