...
public final class HttpRoute implements RouteInfo, Cloneable {
   ...
   public final int hashCode() {
      ...
      if (this.proxyChain != null) {
         for(Iterator i$ = this.proxyChain.iterator(); i$.hasNext(); hash = LangUtils.hashCode(hash, element)) {
            element = (HttpHost)i$.next();
         }
      }
   ...
   public final String toString() {
      ...
      cab.append("}->");
      if (this.proxyChain != null) {
         Iterator i$ = this.proxyChain.iterator();

         while(i$.hasNext()) {
            HttpHost aProxyChain = (HttpHost)i$.next();
