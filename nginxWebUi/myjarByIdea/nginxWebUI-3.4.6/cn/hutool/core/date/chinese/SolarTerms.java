...
public class SolarTerms {
   ...
   private static final String[] TERMS = new String[]{"小寒", "大寒", "立春", "雨水", "惊蛰", "春分", "清明", "谷雨", "立夏", "小满", "芒种", "夏至", "小暑", "大暑", "立秋", "处暑", "白露", "秋分", "寒露", "霜降", "立冬", "小雪", "大雪", "冬至"};
   ...
   private static String getTermInternal(int year, int mouth, int day) {
      if (year >= 1900 && year <= 2100) {
         ...
         String[] segmentTable = new String[]{termInfoStr.substring(0, 1), termInfoStr.substring(1, 3), termInfoStr.substring(3, 4), termInfoStr.substring(4, 6)};
         int segmentOffset = (mouth & 1) == 1 ? 0 : 2;
         if (day == Integer.parseInt(segmentTable[segmentOffset])) {
            return TERMS[segment * 4 + segmentOffset];
         } else {
            return day == Integer.parseInt(segmentTable[segmentOffset + 1]) ? TERMS[segment * 4 + segmentOffset + 1] : "";
         }
      } else {
