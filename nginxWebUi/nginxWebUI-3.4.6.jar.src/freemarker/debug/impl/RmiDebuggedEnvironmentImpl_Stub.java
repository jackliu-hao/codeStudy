...
public final class RmiDebuggedEnvironmentImpl_Stub extends RemoteStub implements DebuggedEnvironment, DebugModel, Remote {
  ...
  static {
    try {
      ...
      $method_getId_10 = DebuggedEnvironment.class.getMethod("getId", new Class[0]);
      $method_getModelTypes_11 = DebugModel.class.getMethod("getModelTypes", new Class[0]);
      $method_keys_12 = DebugModel.class.getMethod("keys", new Class[0]);
      $method_resume_13 = DebuggedEnvironment.class.getMethod("resume", new Class[0]);
      $method_size_14 = DebugModel.class.getMethod("size", new Class[0]);
      $method_stop_15 = DebuggedEnvironment.class.getMethod("stop", new Class[0]);
    } catch (NoSuchMethodException noSuchMethodException) {
      throw new NoSuchMethodError("stub class initialization failed");
    } 
  }
  
  public RmiDebuggedEnvironmentImpl_Stub(RemoteRef paramRemoteRef) {
...
/* Location:              G:\git\codeReviewLog\nginxWebUi\nginxWebUI-3.4.6.jar!\freemarker\debug\impl\RmiDebuggedEnvironmentImpl_Stub.class
