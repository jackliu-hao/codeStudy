...
/* 199 */       Pattern.matches("org/objectweb/asm/util/Trace" + member + "Visitor(\\$.*)?", internalName) || 
/*     */       
/* 201 */       Pattern.matches("org/objectweb/asm/util/Check" + member + "Adapter(\\$.*)?", internalName));
/*     */   }
/*     */   
...
/* 211 */       try { callerClassStream.readInt();
/* 212 */         minorVersion = callerClassStream.readUnsignedShort();
/* 213 */         callerClassStream.close(); } catch (Throwable throwable) { try { callerClassStream.close(); } catch (Throwable throwable1) {} throw throwable; }  } catch (IOException ioe)
/* 214 */     { throw new IllegalStateException("I/O error, can't check class version", ioe); }
/*     */     
/* 216 */     if (minorVersion != 65535)
/* 217 */       throw new IllegalStateException("ASM9_EXPERIMENTAL can only be used by classes compiled with --enable-preview"); 
/*     */   }
/*     */ }


/* Location:              G:\git\codeReviewLog\nginxWebUi\nginxWebUI-3.4.6.jar!\org\objectweb\asm\Constants.class
