...
/* 30 */     this.name = Solon.cfg().get("server.websocket.name");
/* 31 */     this.port = Solon.cfg().getInt("server.websocket.port", 0);
/* 32 */     this.host = Solon.cfg().get("server.websocket.host");
/*    */     
/* 34 */     if (this.port < 1) {
...
/* Location:              G:\git\codeReviewLog\nginxWebUi\nginxWebUI-3.4.6.jar!\org\noear\solon\boot\prop\WebSocketSignalProps.class
