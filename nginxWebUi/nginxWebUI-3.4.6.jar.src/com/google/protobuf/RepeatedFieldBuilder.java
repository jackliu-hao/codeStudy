...
/*     */     }
/*     */     
/* 362 */     for (GeneratedMessage generatedMessage : values) {
/* 363 */       addMessage((MType)generatedMessage);
/*     */     }
/*     */     
/* 366 */     onChanged();
...
/* 379 */     ensureBuilders();
/* 380 */     SingleFieldBuilder<MType, BType, IType> builder = new SingleFieldBuilder<>(message, this, this.isClean);
/*     */     
...
/* 399 */     ensureBuilders();
/* 400 */     SingleFieldBuilder<MType, BType, IType> builder = new SingleFieldBuilder<>(message, this, this.isClean);
/*     */     
...
/* 420 */       SingleFieldBuilder<MType, BType, IType> entry = this.builders.remove(index);
/* 421 */       if (entry != null) {
/* 422 */         entry.dispose();
/*     */       }
/*     */     } 
...
/* 434 */       for (SingleFieldBuilder<MType, BType, IType> entry : this.builders) {
/* 435 */         if (entry != null) {
/* 436 */           entry.dispose();
/*     */         }
/*     */       } 
...
/* 466 */         SingleFieldBuilder<MType, BType, IType> builder = this.builders.get(j);
/* 467 */         if (builder != null && 
...
/* Location:              G:\git\codeReviewLog\nginxWebUi\nginxWebUI-3.4.6.jar!\com\google\protobuf\RepeatedFieldBuilder.class
