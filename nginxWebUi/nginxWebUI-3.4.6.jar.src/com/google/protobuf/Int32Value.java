...
/*     */ 
/*     */     
/* 107 */     this.memoizedIsInitialized = -1; } protected Object newInstance(GeneratedMessageV3.UnusedPrivateParameter unused) { return new Int32Value(); } public final UnknownFieldSet getUnknownFields() { return this.unknownFields; } private Int32Value() { this.memoizedIsInitialized = -1; }
/*     */   private Int32Value(CodedInputStream input, ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException { this(); if (extensionRegistry == null)
/*     */       throw new NullPointerException();  UnknownFieldSet.Builder unknownFields = UnknownFieldSet.newBuilder(); try { boolean done = false; while (!done) { int tag = input.readTag(); switch (tag) { case 0: done = true; continue;case 8: this.value_ = input.readInt32(); continue; }  if (!parseUnknownField(input, unknownFields, extensionRegistry, tag))
...
/* 115 */     return true; } public static final Descriptors.Descriptor getDescriptor() { return WrappersProto.internal_static_google_protobuf_Int32Value_descriptor; } protected GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
...
/* 122 */       output.writeInt32(1, this.value_);
/*     */     }
...
/* 134 */       size += 
/* 135 */         CodedOutputStream.computeInt32Size(1, this.value_);
/*     */     }
...
/* 145 */       return true;
/*     */     }
/* 147 */     if (!(obj instanceof Int32Value)) {
/* 148 */       return super.equals(obj);
/*     */     }
/* 150 */     Int32Value other = (Int32Value)obj;
/*     */     
...
/* 206 */     return 
/* 207 */       GeneratedMessageV3.<Int32Value>parseWithIOException(PARSER, input);
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/* 213 */     return 
/* 214 */       GeneratedMessageV3.<Int32Value>parseWithIOException(PARSER, input, extensionRegistry);
/*     */   }
/*     */   
/*     */   public static Int32Value parseDelimitedFrom(InputStream input) throws IOException {
/* 218 */     return 
/* 219 */       GeneratedMessageV3.<Int32Value>parseDelimitedWithIOException(PARSER, input);
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/* 225 */     return 
/* 226 */       GeneratedMessageV3.<Int32Value>parseDelimitedWithIOException(PARSER, input, extensionRegistry);
/*     */   }
/*     */ 
/*     */   
/*     */   public static Int32Value parseFrom(CodedInputStream input) throws IOException {
/* 231 */     return 
/* 232 */       GeneratedMessageV3.<Int32Value>parseWithIOException(PARSER, input);
/*     */   }
/*     */ 
/*     */ 
/*     */   
...
/* 238 */     return 
/* 239 */       GeneratedMessageV3.<Int32Value>parseWithIOException(PARSER, input, extensionRegistry);
/*     */   }
/*     */   
...
/* 276 */       return WrappersProto.internal_static_google_protobuf_Int32Value_descriptor;
/*     */     }
/*     */ 
/*     */ 
/*     */     
/*     */     protected GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
/* 282 */       return WrappersProto.internal_static_google_protobuf_Int32Value_fieldAccessorTable
/* 283 */         .ensureFieldAccessorsInitialized((Class)Int32Value.class, (Class)Builder.class);
/*     */     }
/*     */ 
/*     */ 
/*     */     
...
/* 313 */       return WrappersProto.internal_static_google_protobuf_Int32Value_descriptor;
/*     */     }
/*     */ 
/*     */     
/*     */     public Int32Value getDefaultInstanceForType() {
/* 318 */       return Int32Value.getDefaultInstance();
/*     */     }
/*     */ 
/*     */     
/*     */     public Int32Value build() {
/* 323 */       Int32Value result = buildPartial();
...
/* 332 */       Int32Value result = new Int32Value(this);
...
/* 372 */       if (other instanceof Int32Value) {
/* 373 */         return mergeFrom((Int32Value)other);
/*     */       }
...
/* 381 */       if (other == Int32Value.getDefaultInstance()) return this; 
...
/* 400 */       Int32Value parsedMessage = null;
/*     */       try {
/* 402 */         parsedMessage = Int32Value.PARSER.parsePartialFrom(input, extensionRegistry);
/* 403 */       } catch (InvalidProtocolBufferException e) {
/* 404 */         parsedMessage = (Int32Value)e.getUnfinishedMessage();
...
/*     */ 
/*     */   
/* 474 */   private static final Int32Value DEFAULT_INSTANCE = new Int32Value();
/*     */ 
/*     */   
...
/*     */ 
/*     */   
/* 486 */   private static final Parser<Int32Value> PARSER = new AbstractParser<Int32Value>()
/*     */     {
/*     */ 
/*     */       
...
/*     */       {
/* 492 */         return new Int32Value(input, extensionRegistry);
/*     */       }
/*     */     };
/*     */   
...
/* Location:              G:\git\codeReviewLog\nginxWebUi\nginxWebUI-3.4.6.jar!\com\google\protobuf\Int32Value.class
