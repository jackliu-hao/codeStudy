...
/*  80 */     this.message = (MType)Internal.<AbstractMessage>checkNotNull((AbstractMessage)message);
...
/* 160 */     this.message = (MType)Internal.<AbstractMessage>checkNotNull((AbstractMessage)message);
...
/*     */ 
/*     */       
/* 196 */       .message = (MType)((this.message != null) ? (AbstractMessage)this.message.getDefaultInstanceForType() : (AbstractMessage)this.builder.getDefaultInstanceForType());
...
/* Location:              G:\git\codeReviewLog\nginxWebUi\nginxWebUI-3.4.6.jar!\com\google\protobuf\SingleFieldBuilderV3.class
