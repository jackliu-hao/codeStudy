...
/*  56 */     int total = 0;
/*  57 */     int ecCodewords = ecBlocks[0].getECCodewordsPerBlock(); ECB[] arrayOfECB; int i;
/*     */     byte b;
/*  59 */     for (i = (arrayOfECB = ecBlocks[0].getECBlocks()).length, b = 0; b < i; ) { ECB ecBlock = arrayOfECB[b];
/*  60 */       total += ecBlock.getCount() * (ecBlock.getDataCodewords() + ecCodewords); b++; }
/*     */     
...
/* 104 */     if (versionNumber <= 0 || versionNumber > 40) {
...
/*     */       int targetVersion;
/*     */       
/* 116 */       if ((targetVersion = VERSION_DECODE_INFO[i]) == versionBits) {
/* 117 */         return getVersionForNumber(i + 7);
/*     */       }
/*     */       
/*     */       int bitsDifference;
/*     */       
/* 122 */       if ((bitsDifference = FormatInformation.numBitsDiffering(versionBits, targetVersion)) < bestDifference) {
/* 123 */         bestVersion = i + 7;
...
/*     */     BitMatrix bitMatrix;
/*     */     
/* 144 */     (bitMatrix = new BitMatrix(dimension)).setRegion(0, 0, 9, 9);
/*     */     
...
/* 198 */       int total = 0; Version.ECB[] arrayOfECB; int i; byte b;
/* 199 */       for (i = (arrayOfECB = this.ecBlocks).length, b = 0; b < i; ) { Version.ECB ecBlock = arrayOfECB[b];
/* 200 */         total += ecBlock.getCount(); b++; }
/*     */       
/* 202 */       return total;
/*     */     }
/*     */     
...
/* Location:              G:\git\codeReviewLog\nginxWebUi\nginxWebUI-3.4.6.jar!\com\google\zxing\qrcode\decoder\Version.class
