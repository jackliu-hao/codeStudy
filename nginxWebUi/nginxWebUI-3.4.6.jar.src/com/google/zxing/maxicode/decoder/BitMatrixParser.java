...
/* 69 */     this.bitMatrix = bitMatrix;
/*    */   }
/*    */   
/*    */   byte[] readCodewords() {
/* 73 */     byte[] result = new byte[144];
/* 74 */     int height = this.bitMatrix.getHeight();
/* 75 */     int width = this.bitMatrix.getWidth();
/* 76 */     for (int y = 0; y < height; y++) {
/* 77 */       int[] bitnrRow = BITNR[y];
/* 78 */       for (int x = 0; x < width; x++) {
/*    */         int bit;
/* 80 */         if ((bit = bitnrRow[x]) >= 0 && this.bitMatrix.get(x, y)) {
/* 81 */           result[bit / 6] = (byte)(result[bit / 6] | (byte)(1 << 5 - bit % 6));
/*    */         }
/*    */       } 
/*    */     } 
/* 85 */     return result;
...
/* Location:              G:\git\codeReviewLog\nginxWebUi\nginxWebUI-3.4.6.jar!\com\google\zxing\maxicode\decoder\BitMatrixParser.class
