...
/*     */     
/*     */     StringBuilder sb;
/* 107 */     (sb = new StringBuilder(symbolInfo.getDataCapacity() + symbolInfo.getErrorCodewords())).append(codewords);
/*     */     int blockCount;
/* 109 */     if ((blockCount = symbolInfo.getInterleavedBlockCount()) == 1) {
...
/* Location:              G:\git\codeReviewLog\nginxWebUi\nginxWebUI-3.4.6.jar!\com\google\zxing\datamatrix\encoder\ErrorCorrection.class
