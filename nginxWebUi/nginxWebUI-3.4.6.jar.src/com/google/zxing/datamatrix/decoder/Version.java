...
/*     */     
/*  53 */     int total = 0;
/*  54 */     int ecCodewords = ecBlocks.getECCodewords(); ECB[] arrayOfECB; int i;
/*     */     byte b;
/*  56 */     for (i = (arrayOfECB = ecBlocks.getECBlocks()).length, b = 0; b < i; ) { ECB ecBlock = arrayOfECB[b];
/*  57 */       total += ecBlock.getCount() * (ecBlock.getDataCodewords() + ecCodewords); b++; }
/*     */     
...
/* 100 */       throw FormatException.getFormatInstance();  Version[] arrayOfVersion;
/*     */     int i;
/*     */     byte b;
/* 103 */     for (i = (arrayOfVersion = VERSIONS).length, b = 0; b < i; ) {
/* 104 */       Version version; if ((version = arrayOfVersion[b]).symbolSizeRows == numRows && version.symbolSizeColumns == numColumns) {
/* 105 */         return version;
/*     */       }
/*     */       b++;
/*     */     } 
...
/* Location:              G:\git\codeReviewLog\nginxWebUi\nginxWebUI-3.4.6.jar!\com\google\zxing\datamatrix\decoder\Version.class
