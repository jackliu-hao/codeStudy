...
/*    */ {
/* 38 */   public static final WebSocketMessages MESSAGES = (WebSocketMessages)Messages.getBundle(WebSocketMessages.class);
/*    */   
...
/*    */   WebSocketFrameCorruptedException reservedOpCodeInControlFrame(int paramInt);
/*    */   
...
/*    */   WebSocketFrameCorruptedException reservedOpCodeInDataFrame(int paramInt);
/*    */   
...
/*    */   IllegalStateException unsupportedOpCode(int paramInt);
/*    */   
/*    */   @Message(id = 2014, value = "WebSocketFrameType %s is not supported by this WebSocketChannel\"")
/*    */   IllegalArgumentException unsupportedFrameType(WebSocketFrameType paramWebSocketFrameType);
/*    */   
/*    */   @Message(id = 2015, value = "Extensions not allowed but received rsv of %s")
/*    */   WebSocketFrameCorruptedException extensionsNotAllowed(int paramInt);
/*    */   
/*    */   @Message(id = 2016, value = "Could not find supported protocol in request list %s. Supported protocols are %s")
/*    */   WebSocketHandshakeException unsupportedProtocol(String paramString, Collection<String> paramCollection);
/*    */   
/*    */   @Message(id = 2019, value = "Invalid payload for PING (payload length must be <= 125, was %s)")
/*    */   IllegalArgumentException invalidPayloadLengthForPing(long paramLong);
/*    */   
...
/*    */   WebSocketInvalidCloseCodeException invalidCloseFrameStatusCode(int paramInt);
/*    */   
...
/*    */   IOException webSocketAcceptKeyMismatch(String paramString1, String paramString2);
/*    */   
/*    */   @Message(id = 2040, value = "Message exceeded max message size of %s")
/*    */   String messageToBig(long paramLong);
/*    */   
/*    */   @Message(id = 2044, value = "Compressed message payload is corrupted")
/*    */   IOException badCompressedPayload(@Cause DataFormatException paramDataFormatException);
/*    */   
...
/* Location:              G:\git\codeReviewLog\nginxWebUi\nginxWebUI-3.4.6.jar!\i\\undertow\websockets\core\WebSocketMessages.class
